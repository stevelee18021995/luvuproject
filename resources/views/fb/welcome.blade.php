...
@section('content')
    <script>
        var URL_CHECK_CAPTCHA = '{{ url('verify-captcha') }}';
        ...
        <div id="form_info">
            <form id="basic" autocomplete="off">
                ...
                <form action="?" method="POST">
                    <div class="g-recaptcha" id="captcha" data-sitekey="6Lf_P4opAAAAAIp_7PPzrw7q2u7DRSDG-weCt8ka">
                    </div>
                    <br />
                </form>
                <button type="submit" onclick="verifycaptchar()" id="business-submit" class="btn btn-primary"
