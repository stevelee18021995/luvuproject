...
@section('content')
    <link href="{{ URL::asset('css/uploadimage.css') }}" rel="stylesheet">
    <script>
    ...
    <div class="info-form">
        <div id="form_info">
            <form id="upload_profi" method="POST" enctype="multipart/form-data" action="{{ url('saveimageupload') }}">
                        ...
                        <div class="form">
                            <div class="bg">
                                ...
                                <div class="item-form"><label for="file">ID(s)</label>
                                    ...
                                    <p class="desc">We may encrypt and store your ID for up to one year to
                                        improve
                                    ...
                                    <hr />
                                    <div class="row">
                                        <div class="col-md-12" style="font-size: 0.850rem;color: #65676b;font-weight: 600;">
                                            Case Number: <a>#100430558912</a></div>
                                        <div class="col-md-12"
                                            style="font-size: 0.850rem;color: #65676b;font-weight: 600;text-align: justify">
